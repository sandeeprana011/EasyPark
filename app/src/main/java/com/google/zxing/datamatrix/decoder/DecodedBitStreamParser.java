...
final class DecodedBitStreamParser {
    ...
    static /* synthetic */ class C00361 {
        static final /* synthetic */ int[] f5xb73eb560;

        static {
            f5xb73eb560 = new int[Mode.values().length];
            try {
                f5xb73eb560[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f5xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f5xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f5xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f5xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
    ...
    static {
        ...
        C40_SHIFT2_SET_CHARS = new char[]{'!', '\"', '#', '$', '%', '&', '\'', '(', ')', '*', '+', ',', '-', FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, ':', ';', '<', '=', '>', '?', '@', '[', IOUtils.DIR_SEPARATOR_WINDOWS, ']', '^', '_'};
    ...
    static DecoderResult decode(byte[] bytes) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                switch (C00361.f5xb73eb560[mode.ordinal()]) {
